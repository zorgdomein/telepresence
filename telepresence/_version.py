...
# This copy, modified for Telepresence, is licensed as above. Our
...
def get_config() -> VersioneerConfig:
    ...
    cfg.tag_prefix = ""
    cfg.parentdir_prefix = "telepresence-"
    cfg.versionfile_source = "telepresence/_version.py"
    cfg.verbose = False
    return cfg
